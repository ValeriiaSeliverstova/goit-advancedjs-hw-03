...
</li>`).join("");e.insertAdjacentHTML("beforeend",i),s=new f(".gallery-link",{captionsData:"alt",captionDelay:250,overlay:!0,overlayOpacity:.8}),s.refresh()}const L=document.querySelector(".form"),S=document.querySelector('input[name="search-input"]');L.addEventListener("submit",o=>{o.preventDefault();const e=S.value.trim();if(!e)return l.error({title:"",message:"Please enter a search query!"});g(e).then(i=>{v(i)}).catch(i=>{throw i.message})});
